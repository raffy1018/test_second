    ...
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto%;">
            ...
            <div class="d-flex justify-content-start">
                <input type="text" style="text-align:center;" class="form-control rounded-pill" name="account_no" id="account_number" value="{{ $customer->account_no }}">
                <i id="eyeStatus" class="fas fa-plus-square" title="Generate new account number" style="margin-left:-30px;margin-top:11px;z-index:2;" onclick="getAccNum()"></i>
            </div>
        </div>
    </div>
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto%;">
            ...
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="first_name" placeholder="Enter First Name" required="" value="{{ $customer->first_name }}">
        </div>
    </div>
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto%;">
            <div class="d-flex justify-content-start">Last Name:</div>
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="last_name" placeholder="Enter Last Name" value="{{ $customer->last_name }}">
        </div>
    </div>
</div>
<div class="row px-5">
    <div class=" col-lg-9 col-md-12 mb-1">
        <div class="form-group" style="width: auto%;">
            ...
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="address" placeholder="Enter Billing Address" value="{{ $customer->address }}">
        </div>
    </div>
    <div class=" col-lg-3 col-md-12 mb-1">
        <div class="form-group" style="width: auto%;">
            <div class="d-flex justify-content-start">Area:</div>
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="area" placeholder="Enter Area" value="{{ $customer->area }}">
        </div>
    </div>
</div>
<div class="row px-5 pb-3">
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto;">
            ...
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="contact_no" placeholder="Enter Contact Number" value="{{ $customer->contact_no }}">
        </div>
    </div>
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto;">
            <div class="d-flex justify-content-start">Email Address:</div>
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="email" placeholder="Enter Email Address" value="{{ $customer->email }}">
        </div>
    </div>
    <div class=" col-lg-4 col-md-12 mb-1">
        <div class="form-group" style="width: auto;">
            ...
            <div class="d-flex justify-content-start">
                <input type="text" style="text-align:center;" class="form-control rounded-pill" name="coordinates" id="coordinates" placeholder="Enter Coordinates" value="{{ $customer->coordinates }}">
                <i class="fas fa-map-pin" style="margin-left:-30px;margin-top:11px;z-index:2;" onclick="getLocation()"></i>
            </div>
...
<div class="row px-5 mb-2">
    <div class=" col-lg-3 col-md-6 mb-1">
        ...
        <div class="d-flex justify-content-center">
            <div class="form-check mx-2 mt-2">
                <input class="form-check-input" type="radio" name="gender" value="Male" id="flexRadioDefault1" {{ $customer->gender === 'Male' ? 'checked' : '' }}>
                <label class="form-check-label" for="flexRadioDefault1">
                    Male
                </label>
            </div>
            <div class="form-check mx-2 mt-2">
                <input class="form-check-input" type="radio" name="gender" value="Female" id="flexRadioDefault2" {{ $customer->gender === 'Male' ? 'checked' : '' }}>
    ...
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
            ...
            <input type="date" style="text-align:center;" class="form-control rounded-pill" name="birth_date" placeholder="Enter Birthday" value="{{ old('birth_date', $customer->birth_date) }}">
        </div>
    </div>
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
    ...
    <div class=" col-lg-3 col-md-12 mb-1">
        <div class="form-group" style="width: auto;">
            ...
            <select id="olt-device" class="btn btn-white border form-control rounded-pill" style="text-align:left;width:100%;" name="olt_device">
                ...
                @forelse(\App\Models\OltDevice::all() as $olt)
                    @if($profile && $profile->olt_device_id == $olt->id)
...
<div class="row px-5 mt-4 mb-3">
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
            ...
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="onu_name" placeholder="Enter ONU Name" value="{{ $profile ? $profile->onu_name : '' }}">
        </div>
    </div>
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
            <div class="d-flex justify-content-start">MAC Address:</div>
            <input id="mac" type="text" style="text-align:center;" class="form-control rounded-pill" name="mac_address" placeholder="XX:XX:XX:XX:XX:XX" value="{{ $profile ? $profile->mac_address : ''  }}">
        </div>
    </div>
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
            <div class="d-flex justify-content-start">Remarks 1:</div>
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="remarks_1" placeholder="Enter Remarks" value="{{ $profile ? $profile->remarks_1 : '' }}">
        </div>
    </div>
    <div class=" col-lg-3 col-md-6 mb-1">
        <div class="form-group" style="width: auto;">
            <div class="d-flex justify-content-start">Remarks 2:</div>
            <input type="text" style="text-align:center;" class="form-control rounded-pill" name="remarks_2" placeholder="Enter Remarks" value="{{ $profile ? $profile->remarks_2 : '' }}">
        </div>
    </div>
</div>
...
@section('js_after')
    ...
    <script type="text/javascript">
        var account_no = @json($customer->account_no);
        var profile = @json($profile);

        if(profile) {
            var olt_device_id = profile.olt_device_id;
            var pon_port_id = profile.pon_port_id;
            var nap_device_id = profile.nap_device_id;
            var nap_port_id = profile.nap_port_id;

            fetchPonPorts(olt_device_id);
            fetchNapDevices(pon_port_id);
            fetchNapPorts(nap_device_id);
        }
        // OLT DEVICE
        ...
        function fetchPonPorts(olt_device_id) {
            if(olt_device_id) {
                olt = olt_device_id;
            }
            ...
            axios.post('{{ route("api.subscriptions.olt-device") }}', {
                ...
                $.each(res.data, function(key, value) {
                    if(profile && olt_device_id === value.value) {
                        $('#pon-port').append('<option value="' + value.value + '" selected="">' + value.label + '</option>');
                    } else {
        ...
        function fetchNapDevices(pon_port_id) {
            if(pon_port_id) {
                pon = pon_port_id;
            }
            ...
            axios.post('{{ route("api.subscriptions.pon-port") }}', {
                ...
                $.each(res.data, function(key, value) {
                    if(profile && pon_port_id === value.value) {
                        $('#nap-device').append('<option value="' + value.value + '" selected="">' + value.label + '</option>');
                    } else {
                        $('#nap-device').append('<option value="' + value.value + '">' + value.label + '</option>');
                    }
                });

                $('[name="nap_device"]').val(nap).trigger('change');
            });
        }
        ...
        function fetchNapPorts(nap_device_id) {
            if(nap_device_id) {
                nap = nap_device_id;
            }
            ...
            axios.post('{{ route("api.subscriptions.nap-device") }}', {
                ...
                $.each(res.data, function(key, value) {
                    if(profile && nap_port_id === value.value) {
                        $('#nap-port').append('<option value="' + value.value + '" selected="">' + value.label + '</option>');
                    } else {
