...
<div class="container-fluid">
    ...
    {{--<div class="my-3">
            Customers Record<span class="my-auto mx-3"><i class="fas fa-chevron-right"></i></span>
        </div>--}}
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="my-auto">
                <h6 class="m-0 font-weight-bold text-secondary">Customers Record</h6>
            </div>
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ route('backoffice.subscriptions.customers.index') }}" class="text-decoration-none mx-1 text-secondary">CURRENT</a>
                     | 
                    <a href="{{ route('backoffice.subscriptions.archived-test') }}" class="text-decoration-none mx-1 text-success">ARCHIVED</a>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive table-sm">
                ...
                <table class="table table-striped table-hover table-vcenter js-dataTable-full" id="records-table">
                    <thead>
                        <tr>
                            <th>Account</th>
                            <th>Date</th>
