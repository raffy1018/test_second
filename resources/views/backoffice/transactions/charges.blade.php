...
@section('js_after')
    ...
    <script type="text/javascript">
        $('#charges-table').dataTable({
            ...
            "serverSide": true,
            "pageLength": 25,
            "ajax": "{{ route('api.transactions.charges') }}",
            "columns": [
                ...
                { "data": "debit", "render": function(data, type, row) { return 'P'+row.debit; }},
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ route('backoffice.transactions.payments.index') }}" class="text-decoration-none mx-1 text-success">PAYMENTS</a>
                     | 
                    <a href="{{ route('backoffice.transactions.charges.index') }}" class="text-decoration-none mx-1 text-secondary">CHARGES</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive table-sm">
                <table class="table table-striped table-hover table-vcenter js-dataTable-full" id="charges-table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Date</th>
